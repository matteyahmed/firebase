...
from fire_base_admin.firebase import default_app
...
SECRET_KEY = 'django-insecure-@mu(ebp$lp6ysmo(p=0)#tam=twnn@#=_7m828gb&8b)h&xolb'
...
ROOT_URLCONF = 'fire_base_admin.urls'
...
WSGI_APPLICATION = 'fire_base_admin.wsgi.application'
...
REST_KNOX = {
    ...
    'TOKEN_TTL': timedelta(days=1), # The default is 10 hours i.e., timedelta(hours=10)).
